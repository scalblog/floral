...
<html lang="fr">
  ...
  <body>
    ...
    <header>
        <!--
        <div class="top_head_banner  sticky-top">
           <div class="container">
                <div class="row">
                    <div class="col-sm-4">
...
<!--        <div class="real-header"> -->
            <!--<div class="container">-->
            <div><!-- à la place du div class container -->
                <nav class="navbar navbar-expand-lg another-navbar">
                <!--<nav class="navbar fixed-top navbar-expand-lg  navbar-light bg-light another-navbar"> -->
...
<!-- fin de la div real-header        </div> -->
            
            <!--
            <nav class="navbar navbar-expand-lg">
                <a class="navbar-brand" href="#">Flowers<img src="https://v4-alpha.getbootstrap.com/assets/brand/bootstrap-social-logo.png" width="30" height="30" class="d-inline-block align-top" alt=""></a>
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>
